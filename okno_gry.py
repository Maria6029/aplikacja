...
class GlowneOkno(QMainWindow):
   ...
   def setJezyk(self, jezyk):
       ...
       # Jeżeli jesteśmy w trakcie gry, odśwież teksty w oknie gry
   ...
   def initUI(self):
       ...
       self.grupa1.setMinimumWidth(500)
       self.grupa1.setMaximumWidth(650)
      
       self.napis_nazwa_swoja = QLabel(self.translate("enter_name"))
       self.napis_nazwa_swoja.setStyleSheet(f"font-family: 'Segoe UI'; font-size: 18px; color: {rgb(100, 116, 139)}; font-weight: normal; background-color: transparent;")
       ...
       self.etykieta_jezyk.setStyleSheet(f"font-family: 'Segoe UI'; font-size: 18px; color: {rgb(100, 116, 139)}; font-weight: normal; background-color: transparent;")
       ...
       self.przycisk_en.setStyleSheet(style_language_button)
       ...
       self.pasek_jezyka.addWidget(self.przycisk_pl)
       self.pasek_jezyka.addWidget(self.przycisk_ua)
       self.pasek_jezyka.addWidget(self.przycisk_en)
       ...
       menu_layout.addWidget(self.grupa2)
       menu_layout.addStretch(1)
